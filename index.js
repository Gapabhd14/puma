...
let arrSubject = ["פגיעות מכניות", "מיגונים", "פרטי מסגרות", "ווי גרירה", "תאי אחסון", "שקעי סער", "עשן מיידי", "כנות מקלעים", "פתח מילוי", "תאורה וצופר", "מדפים ואטמים", "תקינות פעולה", "מצברים",
    ...
    "מדומם מנוע", "גופים זרים", "מתיחת זחל", "נזילות", "מתלים", " גלגלי מרכוב", "גלגלי מתח", "גלגלי תמך", "זרי מניע", "טבורים", "חוליות זחל", "הידוק ברגים", " מזקו״מ ", " חט״כ וממסרת", "בדיקת מערכות שליטה","שימונים וגירוזים"];
// שיטת ביצוע
let arrExecutaion = [`בדוק העדר פגיעות מכניות קשות בכלי`, "בדוק שלמות מודולי המיגון, מיגוני הצד הכבדים/קלים והידוקם לכלי", "בדוק שלמות והידוק הכנפיים, הרצפות החיצוניות, כבלי העליה ומדרגות הכלי",
    ...
    'להרחיק גופים מכלל המזקום ולוודא שסביבת המזקום נקייה מאביזרים', 'חת״כ', '1) בדוק תפעול תקין (בהמלך תנועה קצרה של הכלי) של מערכת ההגוי, ההילוכים, המאיץ הבלום ובלם החניה. <br> 2) בדוק תפעול תקין של מאיץ יד','שימונים וגירוזים'];
// פרק
let arrSection = ["", "", "", ``, "", "", ``, "", "", "", "", "", ``, "","", ``, "","","",""];
