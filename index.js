// נושא מטופל
let arrSubject = ["פגיעות מכניות", "מיגונים", "פרטי מסגרות", "ווי גרירה", "תאי אחסון", "שקעי סער", "עשן מיידי", "כנות מקלעים", "פתח מילוי", "רתמות", "מדפים ואטמים", "תקינות פעולה", "מצברים",
    ...
    "מדומם מנוע", "גופים זרים", "מתיחת זחל", "נזילות", "מתלים", " גלגלי מרכוב", "גלגלי מתח", "גלגלי תמך", "זרי מניע", "טבורים", "חוליות זחל", "הידוק ברגים", "גירוזים, מזקום, הינע סופי ומפרקים", " חט״כ וממסרת", "בדיקת מערכות שליטה"];
// שיטת ביצוע
let arrExecutaion = [`בדוק העדר פגיעות מכניות קשות בכלי`, "בדוק שלמות מודולי המיגון, מיגוני הצד הכבדים/קלים והידוקם לכלי", "בדוק שלמות והידוק הכנפיים, הרצפות החיצוניות, כבלי העליה ומדרגות הכלי",
    ...
    'בדוק ניקיון התובה, תא הלחימה והמזקו״מ', '1) בדוק ניקיון הטובלנים וחריצי הנעילה <br> 2) בדוק תנועה חופשית של כל הטובלנים וחדירתם המלאה לתוך חריצי הנעילה במצבי הפעולה השונים <br> 3) בדוק שמדפי מפקד, מקלען ופלסים אינם מתנדנדים במצב פתוח <br> 4) בדוק נעילת המדפים בכל המצבים', 'כסאות',
    ...
    'מזקו״מ', '1) בדוק תפעול תקין (בהמלך תנועה קצרה של הכלי) של מערכת ההגוי, ההילוכים, המאיץ הבלום ובלם החניה. <br> 2) בדוק תפעול תקין של מאיץ יד'];
// פרק
...
let pumaVideoLength = [{ startVideoNum: 0, manyVideos: 1 }, { startVideoNum: 1, manyVideos: 1 }, { startVideoNum: 2, manyVideos: 1 }, { startVideoNum: 3, manyVideos: 1 }, { startVideoNum: 4, manyVideos: 1 }, { startVideoNum: 5, manyVideos: 1 }, { startVideoNum: 6, manyVideos: 5 }, { startVideoNum: 7, manyVideos: 0 }, { startVideoNum: 8, manyVideos: 2 }, { startVideoNum: 9, manyVideos: 0 }, { startVideoNum: 10, manyVideos: 2 }, { startVideoNum: 11, manyVideos: 3 }, { startVideoNum: 12, manyVideos: 1 }, { startVideoNum: 13, manyVideos: 0 }, { startVideoNum: 14, manyVideos: 1 }, { startVideoNum: 15, manyVideos: 0 }, { startVideoNum: 16, manyVideos: 1 }, { startVideoNum: 17, manyVideos: 1 }, { startVideoNum: 18, manyVideos: 1 }, { startVideoNum: 19, manyVideos: 1 }, { startVideoNum: 20, manyVideos: 1 }, { startVideoNum: 21, manyVideos: 0 }, { startVideoNum: 22, manyVideos: 0 }, { startVideoNum: 23, manyVideos: 0 }, { startVideoNum: 24, manyVideos: 0 }, { startVideoNum: 25, manyVideos: 0 }, { startVideoNum: 26, manyVideos: 0 }, { startVideoNum: 27, manyVideos: 0 }, { startVideoNum: 28, manyVideos: 0 }, { startVideoNum: 29, manyVideos: 1 }, { startVideoNum: 30, manyVideos: 0 }, { startVideoNum: 31, manyVideos: 1 }, { startVideoNum: 32, manyVideos: 0 }, { startVideoNum: 33, manyVideos: 1 }, { startVideoNum: 34, manyVideos: 1 }, { startVideoNum: 35, manyVideos: 1 }, { startVideoNum: 36, manyVideos: 0 }, { startVideoNum: 37, manyVideos: 0 }, { startVideoNum: 38, manyVideos: 1 }, { startVideoNum: 39, manyVideos: 1 }, { startVideoNum: 40, manyVideos: 0 }, { startVideoNum: 41, manyVideos: 0 }, { startVideoNum: 42, manyVideos: 0 }, { startVideoNum: 43, manyVideos: 0 }, { startVideoNum: 44, manyVideos: 0 }, { startVideoNum: 45, manyVideos: 0 }, { startVideoNum: 46, manyVideos: 0 }, { startVideoNum: 47, manyVideos: 0 }, { startVideoNum: 48, manyVideos: 0 }, { startVideoNum: 49, manyVideos: 0 }, { startVideoNum: 50, manyVideos: 0 }, { startVideoNum: 51, manyVideos: 0 }, { startVideoNum: 52, manyVideos: 0 }, { startVideoNum: 53, manyVideos: 0 }, { startVideoNum: 54, manyVideos: 1 }, { startVideoNum: 55, manyVideos: 0 }, { startVideoNum: 56, manyVideos: 1 }, { startVideoNum: 57, manyVideos: 1 }, { startVideoNum: 58, manyVideos: 0 }, { startVideoNum: 59, manyVideos: 2 }, { startVideoNum: 60, manyVideos: 1 }, { startVideoNum: 61, manyVideos: 0 }, { startVideoNum: 62, manyVideos: 0 }, { startVideoNum: 63, manyVideos: 1 }, { startVideoNum: 64, manyVideos: 1 }, { startVideoNum: 65, manyVideos: 1 }, { startVideoNum: 66, manyVideos: 1 }, { startVideoNum: 67, manyVideos: 1 }, { startVideoNum: 68, manyVideos: 1 }, { startVideoNum: 69, manyVideos: 1 }];
